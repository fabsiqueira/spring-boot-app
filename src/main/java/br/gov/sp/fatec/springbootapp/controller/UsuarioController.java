...
// os metódos poderão ser rotas/servicos
@RestController //implementar o controller
...
public class UsuarioController {
    ...
    public Autorizacao buscAutorizacaoPorNome(@PathVariable("autorizacao")String nome){
